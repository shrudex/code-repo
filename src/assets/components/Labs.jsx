...
const Labs = ({ sub, subject, lang }) => {
  ...
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex justify-center items-center">
      <div className="p-5">
        <NavLink to={link}>
          <h5 className="heading mb-2 text-2xl font-medium text-center tracking-tight text-gray-900 dark:text-white">
            {subject}
          </h5>
        </NavLink>
        <p className="mb-3 text-center font-normal text-gray-700 dark:text-gray-400">
          <mark className="px-2 text-black bg-blue-600 rounded-lg dark:bg-yellow-300">
            {lang}
          </mark>
        </p>
