...
const DsWeek06 = () => {
  const qq = {
    week: "06",
    ques: ["Postfix", "Postfix Evaluation", "Prefix", "Prefix Evaluation"],
    desc: [" ", " ", " ", " "],
    links: [
    ...
    <div>
      <div className="items-center flex justify-center text-center explore-breadcrumb dark:text-white text-white">
        ...
        >
          ...
          <Breadcrumb.Item href="/ds/w6">Week 06</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div className="accordion-div mt-24 pt-3 mb-20">
