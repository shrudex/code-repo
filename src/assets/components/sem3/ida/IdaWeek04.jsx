    ...
    <div>
      <div className="items-center flex justify-center text-center explore-breadcrumb !text-white text-white">
        ...
        >
          ...
          <Breadcrumb.Item href="/ida">Data Analytics</Breadcrumb.Item>
          <Breadcrumb.Item href="/ida/w4">Week 04</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div className="accordion-div mt-20 pt-1 mb-64 pb-12">
