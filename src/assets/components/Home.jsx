...
const Home = () => {
  ...
  return (
    <div className="pb-3">
      <div>
        <h1 className="heading mt-16 mb-4 text-5xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl text-center !text-gray-900">
          CodeRepo
        </h1>
        <p className="sub-heading mb-6 text-lg font-normal text-blue-800 lg:text-xl sm:px-16 xl:px-48 !text-blue-800 text-center">
          Your Comprehensive{" "}
          <mark className="px-2 text-white bg-gray-900 rounded !bg-gray-900">
            DSE Branch
          </mark>{" "}
        ...
        <div className="text-center justify-center items-center">
          <NavLink
            to="/explore"
            className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 !focus:ring-blue-900"
          >
            Explore Repository
          </NavLink>
        </div>
      ...
      <div className=" search-code w-8/12 justify-center mx-auto mt-10 mb-0 sm:mb-1 sm:pb-0 ">
        <label
          htmlFor="helper-text"
          className="block mb-2 text-sm font-bold text-black !text-black text-center"
        >
