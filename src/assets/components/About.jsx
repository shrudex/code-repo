        ...
        <figure className="max-w-screen-md mx-auto text-center">
          ...
          <blockquote>
            <p className="text-2xl italic font-medium text-gray-900 dark:text-gray-900">
              ...
              <mark className="px-2 text-white bg-blue-600 dark:bg-blue-400 rounded-2xl">
      ...
      <div className="flex justify-center mb-1 items-center about-card">
        ...
        >
          ...
          <div className="flex flex-col justify-between p-4 leading-normal hover:shadow-outline">
            <h5 className="mb-2 text-2xl font-medium text-center tracking-tight text-gray-900 dark:text-white heading">
              Shubh Sinha
            </h5>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 sub-text text-center">
