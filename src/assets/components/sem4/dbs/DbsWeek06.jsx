...
const DbsWeek06 = () => {
  const qq = {
    ...
    desc: [" ", " ", " ", " "],
    links: [
      "https://gitlab.com/api/v4/projects/50442481/repository/files/Database%20Lab%2FWeek06%2Fcommands.md/raw?ref=main",
    ...
    <div>
      <div className="items-center flex justify-center text-center explore-breadcrumb !text-white text-white">
        ...
        >
          ...
          <Breadcrumb.Item href="/dbs">Database Systems</Breadcrumb.Item>
          <Breadcrumb.Item href="/dbs/w6">Week 06</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div className="accordion-div mt-24 pt-1 mb-44">
